...
public class PlayerController {
	...
	// TODO Luciano arrumar isso aqui
	// fazer um para cada, ou meter o filtro completo
	@CrossOrigin
	...
	public Page<PlayerTite> getPlayers(@RequestBody PlayerFilter filter,
		...
		if (filter.getName().trim().length() > 0) {
			...
			return plDao.findByPositionIgnoreCaseAndRatingGreaterThanEqual(filter.getPosition(), filter.getRating(),
					pageable);
		}
		return null;
	}

	// TODO Luciano arrumar isso aqui, mandar só o id da liga
	@CrossOrigin
