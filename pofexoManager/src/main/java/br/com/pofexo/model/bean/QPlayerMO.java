...
public class QPlayerMO extends EntityPathBase<PlayerMO> {
    ...
    private static final long serialVersionUID = 636250062L;
    ...
    public final EnumPath<br.com.pofexo.model.misc.PlayerStatus> status = createEnum("status", br.com.pofexo.model.misc.PlayerStatus.class);
