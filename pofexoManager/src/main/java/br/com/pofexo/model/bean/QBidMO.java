...
public class QBidMO extends EntityPathBase<BidMO> {
    ...
    private static final long serialVersionUID = -1961597004L;
    ...
    public final EnumPath<br.com.pofexo.model.misc.BidStatus> status = createEnum("status", br.com.pofexo.model.misc.BidStatus.class);
